...
class vtk():
    ...
    def create_vtk(self, lookup_table, Allpoints):
        ...
        with open(vtk_file, 'w') as outfile:
            ...
            outfile.write('SYMMETRY: YES STATICDEF NO\n' )
            outfile.write('ASCII\n')
            ...
            # Cells
            outfile.write('CELLS' + ' ' + num_panels + ' ' + str(int(Allpoints)) + '\n')
            node_per_cell = []
            ...
            # write lookuptable
            outfile.write('CELL_DATA {}\n'.format(num_panels))
            outfile.write('SCALARS module int\n')
            outfile.write('LOOKUP_TABLE default\n')
            for index in lookup_table:
                outfile.write(str(index) + '\n')
            outfile.write('SCALARS hull int\n')
            outfile.write('LOOKUP_TABLE default\n')
            for index in lookup_table:
                outfile.write('0\n')
            outfile.close()
